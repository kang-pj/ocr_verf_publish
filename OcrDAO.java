...
import com.refine.ocr.vo.DetailVO;
import com.refine.ocr.vo.ExtVO;
import com.refine.ocr.vo.ModifyVO;
...
public interface OcrDAO {
    ...
    int getOcrDocumentCount(Map<String, Object> modelMap) throws SQLException;

    List<OcrInfoVO> getOcrDocumentList(Map<String, Object> modelMap) throws SQLException;
    ...
    List<OcrInfoVO> getOcrHisList(Map<String, Object> params);
